...
class BasicConv(tf.Module):
	def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding="same", dilation=1, groups=1, relu=True,
	             bn=True, bias=False):
