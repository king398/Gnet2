...
def build_model(size, ef=EFF_NETS[0], count=820):
	...
	base = tf.keras.models.load_model(
		"gs://kds-9e7eb039486df88ed46e6fba730ed3c9b87d3640f3c4d7d7878fd0c9/efficientnetv2-b1/feature-vector")
...
for fold, (idxT, idxV) in enumerate(skf.split(files_train_g)):
	...
	sv = tf.keras.callbacks.ModelCheckpoint(
		'fold-%i' % fold, monitor='val_auc', verbose=0, save_best_only=True,
